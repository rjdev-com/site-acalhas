  ...
  const services = [
    {
      ...
      image: getContent('service1_image', 'https://images.pexels.com/photos/186077/pexels-photo-186077.jpeg?auto=compress&cs=tinysrgb&w=800'),
    },
    {
      icon: Shield,
      ...
      image: getContent('service2_image', 'https://images.pexels.com/photos/259588/pexels-photo-259588.jpeg?auto=compress&cs=tinysrgb&w=800'),
    },
    {
      icon: Layers,
      ...
      image: getContent('service3_image', 'https://images.pexels.com/photos/2816323/pexels-photo-2816323.jpeg?auto=compress&cs=tinysrgb&w=800'),
    },
    {
      icon: Flame,
      ...
      image: getContent('service4_image', 'https://images.pexels.com/photos/1105766/pexels-photo-1105766.jpeg?auto=compress&cs=tinysrgb&w=800'),
    },
    {
      icon: Wind,
      ...
      image: getContent('service5_image', 'https://images.pexels.com/photos/1599791/pexels-photo-1599791.jpeg?auto=compress&cs=tinysrgb&w=800'),
    },
    {
      icon: Droplets,
      ...
      image: getContent('service6_image', 'https://images.pexels.com/photos/221018/pexels-photo-221018.jpeg?auto=compress&cs=tinysrgb&w=800'),
    },
  ];
